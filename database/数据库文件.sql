...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='帐户' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='员工' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `summary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='总结报告' AUTO_INCREMENT=1 ;
